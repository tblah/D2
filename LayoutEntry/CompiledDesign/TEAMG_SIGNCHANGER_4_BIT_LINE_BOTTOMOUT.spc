...
*
* Extract Date/Time:	Wed Oct 21 11:15:33 2015
* L-Edit Version:		L-Edit Win64 16.25.20150422.06:31:34
*
* Rule Set Name:		
* TDB File Name:		H:\D2ext\LayoutEntry\CompiledDesign\d2COMPILED.tdb
* PX Command File:	
...
XU19 IN1 GND_ Q VDD INV1_H  $ (28.2 30.6 31 43.6) $T=31 30.6 1 180 -1
XU36 IN3 GND_ 1 VDD INV1_H  $ (77.2 30.6 80 43.6) $T=80 30.6 1 180 -1
XU37 2 B GND_ OUT3 VDD XOR21_H  $ (59 30.6 68.8 43.6) $T=68.8 30.6 1 180 -1
XU33 1 IN3 GND_ 2 S VDD MUX21_H  $ (68.8 30.6 77.2 43.6) $T=77.2 30.6 1 180 -1
XU24 3 4 B GND_ OUT2 VDD TEAMG_HALFADDER_RT  $ (42.15 30.6 59 45.5) $T=54 -6.9 0 0 1
XU27 IN2 GND_ 5 VDD INV1_H  $ (31 30.6 33.8 43.6) $T=31 30.6 0 0 1
XU23 5 IN2 GND_ 3 S VDD MUX21_H  $ (33.8 30.6 42.2 43.6) $T=33.8 30.6 0 0 1
XU13 6 S 7 GND_ OUT0 VDD TEAMG_HALFADDER_RT  $ (-13.85 30.6 3 45.5) $T=-2 -6.9 0 0 1
XU20 8 7 4 GND_ OUT1 VDD TEAMG_HALFADDER_RT  $ (3 30.6 19.85 45.5) $T=8 -6.9 1 180 -1
XU18 Q IN1 GND_ 8 S VDD MUX21_H  $ (19.8 30.6 28.2 43.6) $T=28.2 30.6 1 180 -1
XU9 IN0 GND_ 9 VDD INV1_H  $ (-25 30.6 -22.2 43.6) $T=-25 30.6 0 0 1
XU5 9 IN0 GND_ 6 S VDD MUX21_H  $ (-22.2 30.6 -13.8 43.6) $T=-22.2 30.6 0 0 1
